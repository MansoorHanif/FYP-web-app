...
from flaskbb.pet.views import pet
# models
...
def configure_blueprints(app):
    app.register_blueprint(pet, url_prefix=app.config["PET_URL_PREFIX"])
...
def configure_extensions(app):
    ...
    if not app.testing:
        whooshee.register_whoosheer(PetWhoosheer)
    ...
    app.config["TEST_UPLOAD_FOLDER"] = app.static_folder+'/tests/'
    app.config["PET_UPLOAD_FOLDER"] = app.static_folder+'/pets/'
